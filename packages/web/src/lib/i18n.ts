...
const translations = {
  de: {
    ...
    // Timezone
    "tz.yourTimezone": "Deine Zeitzone",
    "tz.hostTimezone": "Zeitzone von {host}",
    "tz.aheadBy": "Du bist {hours}h voraus",
    "tz.behindBy": "Du bist {hours}h zurück",
    "tz.sameTimezone": "Gleiche Zeitzone",
    "tz.timesInYourTimezone": "Zeiten in deiner Zeitzone",
    // Day labels
  ...
  en: {
    ...
    "tz.yourTimezone": "Your timezone",
    "tz.hostTimezone": "{host}'s timezone",
    "tz.aheadBy": "You are {hours}h ahead",
    "tz.behindBy": "You are {hours}h behind",
    "tz.sameTimezone": "Same timezone",
    "tz.timesInYourTimezone": "Times shown in your timezone",
  ...
  fr: {
    ...
    "tz.yourTimezone": "Votre fuseau horaire",
    "tz.hostTimezone": "Fuseau horaire de {host}",
    "tz.aheadBy": "Vous avez {hours}h d'avance",
    "tz.behindBy": "Vous avez {hours}h de retard",
    "tz.sameTimezone": "Même fuseau horaire",
    "tz.timesInYourTimezone": "Horaires dans votre fuseau",
  ...
  es: {
    ...
    "tz.yourTimezone": "Tu zona horaria",
    "tz.hostTimezone": "Zona horaria de {host}",
    "tz.aheadBy": "Estás {hours}h adelantado",
    "tz.behindBy": "Estás {hours}h atrasado",
    "tz.sameTimezone": "Misma zona horaria",
    "tz.timesInYourTimezone": "Horarios en tu zona horaria",
  ...
  nl: {
    ...
    "tz.yourTimezone": "Jouw tijdzone",
    "tz.hostTimezone": "Tijdzone van {host}",
    "tz.aheadBy": "Je bent {hours}u voor",
    "tz.behindBy": "Je bent {hours}u achter",
    "tz.sameTimezone": "Zelfde tijdzone",
    "tz.timesInYourTimezone": "Tijden in jouw tijdzone",
