                    ...
                    <div className="flex-1">
                      ...
                      {savedUsername && et.enabled && (
                        <div className="ml-6 mt-2 space-y-1">
                          ...
                          {et.shortHash && (
                            <div className="flex items-center gap-1.5">
                              <a href={`https://mcal.ink/${et.shortHash}`} target="_blank" rel="noopener noreferrer" className="rounded bg-primary/10 px-2 py-1 text-xs text-primary hover:underline">mcal.ink/{et.shortHash}</a>
                              <Button size="sm" variant="light" isIconOnly className="h-7 w-7 min-w-0" onPress={() => navigator.clipboard.writeText(`https://mcal.ink/${et.shortHash}`)}>
                                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="9" y="9" width="13" height="13" rx="2" ry="2"/><path d="M5 15H4a2 2 0 01-2-2V4a2 2 0 012-2h9a2 2 0 012 2v1"/></svg>
                              </Button>
                            </div>
                          )}
